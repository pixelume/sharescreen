...
const PresentersPage = ({ limit }) => {
  ...
  //   if (regex && presentersArr && presentersArr.length > 0) {
  //     return presentersArr.filter(
  //       (presentation) =>
  ...
  return (
    <>
      ...
      {presentersArr && <Cards presentersArr={presentersArr} limit={limit} />}
